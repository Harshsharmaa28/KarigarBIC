    ...
    return (
        <div className=" h-screen overflow-hidden bg-[url('/fbg.png')] -z-10">
            <div class="mx-auto px-5 z-10">
                <div class="vsm:max-sm:flex vsm:max-sm:items-center vsm:max-sm:justify-center flex flex-col items-center">
                    <h2 class="vsm:max-sm:text-center vsm:max-sm: text-5xl mt-14 tracking-tight font-black">
                ...
                <div className="vsm:max-sm:h-[100%] vsm:max-sm:border-y vsm:max-sm:w-[100%] bg-white border border-black w-[60vw] mx-auto h-[60vh] rounded-xl mt-10 overflow-scroll custom-scrollbar overflow-x-hidden">
                    <div class=" vsm:max-sm:w-[60%] vsm:max-sm: flex flex-col divide-neutral-300 w-[50vw] mt-8 mx-auto">
                        <div class="vsm:max-sm:py-1 py-5 flex flex-col gap-5">
                            <details class="group">
