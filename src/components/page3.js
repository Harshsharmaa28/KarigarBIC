    ...
    return (
        <div className="vsm:max-sm:flex vsm:max-sm:-ml-4 vsm:max-sm: vsm:max-sm:justify-items-center  w-screen flex gap-28 overflow-hidden">
            ...
            <div className=" vsm:max-sm:flex vsm:max-sm:ml-8 vsm:max-sm:flex-wrap vsm:max-sm:justify-items-center  flex flex-col gap-16 ml-16">
                ...
                <div className="vsm:max-sm: vsm:max-sm: flex flex-col gap-10">
                    <div className="flex gap-5">
                        <div className="">
                            <img src="check.svg" className="w-[4rem]" />
                        </div>
                        <div className="">
                            <h1 className="vsm:max-sm:flex vsm:max-sm:flex-wrap font-extrabold text-3xl">Convenience</h1>
                            <p className="vsm:max-sm:flex vsm:max-sm:flex-wrap">Offer the convenience of finding and booking skilled professionals for various tasks from the comfort of their homes.</p>
                        </div>
                    </div>
                    <div className="flex gap-5">
                        <div className="">
                        ...
                        <div>
                            <h1 className="vsm:max-sm:flex vsm:max-sm:flex-wrap font-extrabold text-3xl">Expertise</h1>
                            <p className="vsm:max-sm:flex vsm:max-sm:flex-wrap">Offer the convenience of finding and booking skilled professionals for various tasks from the comfort of their homes.</p>
                        </div>
                    </div>
                    <div className="flex gap-5">
                        ...
                        <div>
                            <h1 className="vsm:max-sm:flex vsm:max-sm:flex-wrap font-extrabold text-3xl">Time-Saving</h1>
                            <p className="vsm:max-sm:flex vsm:max-sm:flex-wrap">Offer the convenience of finding and booking skilled professionals for various tasks from the comfort of their homes.</p>
                        </div>
                    </div>
                </div>
